...
class Register {
  ...
  constructor() {
    ...
    this.$containerMain.setAttribute(
      "class",
      " w-screen  bg-gradient-to-r from-green-400 to-blue-500"
    );
    ...
    this.$logoEl.setAttribute(
      "class",
      "animate-bounce w-auto h-auto ml-20 text-white mt-10 text-6xl font-extrabold uppercase self-center"
    );
    ...
    this.$liContactSupport.setAttribute(
      "class",
      "transform hover:scale-110 motion-reduce:transform-none m-4 mr-36 p-2 bg-green-400 text-white ring ring-green-400 ring-offset-4 ring-offset-green-300 rounded-full uppercase"
    );

    this.$liAboutUs = document.createElement("li");
    this.$liAboutUs.textContent = "about us";
    this.$liAboutUs.setAttribute(
      "class",
      "transform hover:scale-110 motion-reduce:transform-none m-2 p-2 bg-green-400 text-white ring ring-green-400 ring-offset-4 ring-offset-green-300 uppercase self-center rounded-full"
    );
    ...
    this.$formRegister.setAttribute(
      "class",
      "relative w-1/3 m-auto bg-green-100 py-5 px-12 rounded-lg border-solid border-4 border-green-500"
    );
    ...
    this.$submit.setAttribute(
      "class",
      " py-2 px-4 mb-6 border-solid border-4 border-blue-500 rounded uppercase font-black text-white bg-green-400 hover:bg-indigo-500 "
    );
    ...
    this.$switch.setAttribute(
      "class",
      " flex absolute right-4 py-2 px-4 border-solid border-4 border-blue-400 rounded-lg uppercase bg-indigo-600 text-white transform hover:scale-110 motion-reduce:transform-none  font-black"
    );
  }
